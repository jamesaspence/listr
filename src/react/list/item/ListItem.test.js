...
it('matches snapshot', () => {
  expect(shallow(<ListItem item="oranges" onCheck={onCheck} index={1} itemId="123" checked={false} />)).toMatchSnapshot();
});

it('is unchecked correctly', () => {
  const container = shallow(<ListItem onCheck={onCheck} index={1} itemId="123" checked={false} />);
...
it('is checked correctly', () => {
  const container = shallow(<ListItem item="oranges" onCheck={onCheck} index={1} itemId="123" checked={true} />);
